...
ROOT_DIR = Path("results/prices_and_renewables")  # where to look for networks
...
OUTPUT_EXCEL = Path("results/prices_and_renewables/2040/csvs/analysis_networks_power.xlsx")
